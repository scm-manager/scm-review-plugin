...
class Edit extends React.Component<Props, State> {
  ...
  submit = () => {
    ...
    updatePullRequest(modifiedPullRequest._links.update.href, modifiedPullRequest).then(
      result => {
        if (result.error) {
    ...
    return (
      <div className="columns">
        <div className="column is-clipped">
          ...
          <EditForm description={pullRequest.description?pullRequest.description:""} title={pullRequest.title } handleFormChange={this.handleFormChange} />
          <div>
            <SubmitButton
