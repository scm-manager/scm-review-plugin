...
public class CommentRootResourceTest {
  ...
  public void shouldGetAllPullRequestComments() throws URISyntaxException, IOException {
    PullRequestComment comment1 = new PullRequestComment("1", "1. comment", "author", new Location("","",""), Instant.now(), false, false);
    PullRequestComment comment2 = new PullRequestComment("2", "2. comment", "author", new Location("","",""), Instant.now(), false, false);
    PullRequestComment comment3 = new PullRequestComment("3", "3. comment", "author", new Location("","",""), Instant.now(), false, false);
