...
public class PullRequestRootResourceTest {
  ...
  public void init() {
    ...
    pullRequestRootResource = new PullRequestRootResource(mapper, service, Providers.of(new PullRequestResource(mapper, service, null, eventBus)));
  ...
  public void shouldUpdatePullRequestSuccessfully() throws URISyntaxException {
    when(store.get("1")).thenReturn(new PullRequest());
    MockHttpRequest request = MockHttpRequest
