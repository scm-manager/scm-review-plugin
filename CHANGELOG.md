...
## 3.15.1 - 2026-04-28
### Fixed
- Authorization error when listing pull requests overall repositories with MCP tool
- Internal server error when creating global comment with MCP tool

## 3.15.0 - 2026-03-30
### Added
- MCP tool to read and write comments

## 3.14.0 - 2026-03-18
### Added
- Extension for MCP diff tool

### Fixed
- Integration of teamscale plugin (patch from 3.9.4)

## 3.13.4 - 2026-02-13
### Fixed
- Missing pull requests in branch detail view

## 3.13.3 - 2026-02-06
### Fixed
- Input validation for MCP tools
- Mails sent to added reviewers of an edited pull request (patch from 3.9.2)

## 3.13.2 - 2026-01-28
### Fixed
- Title and description in new pull requests created by mcp tool

## 3.13.1 - 2026-01-21
### Fixed
- SCM-Manager hanging up on startup
...
## 3.9.2 - 2026-02-06
### Fixed
- Mails sent to added reviewers of an edited pull request
